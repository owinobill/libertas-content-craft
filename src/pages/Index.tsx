...
import { ChevronRight, ChevronDown, Mail, Phone, MapPin, TrendingUp, Shield, Users, Target, Briefcase, PieChart, FileText, ArrowRight, Menu, X } from "lucide-react";
  ...
  return <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="relative z-50 border-b border-border/50 bg-background/80 backdrop-blur-md supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto px-6 py-6">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <div className="relative group">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-80 bg-background border border-border/50 shadow-lg z-50">
          ...
          {/* Mobile Navigation */}
          {mobileMenuOpen && (
            <nav className="md:hidden mt-6 pb-6 border-t border-border/50 pt-6">
              <div className="flex flex-col space-y-4">
                ...
                <div className="space-y-2">
                  <button
                    className="nav-item flex items-center justify-between w-full py-2"
                  ...
                  >
                    ...
                    <ChevronRight 
                      className={`h-4 w-4 transition-transform ${mobileSolutionsOpen ? 'rotate-90' : ''}`} 
                    />
                  </button>
